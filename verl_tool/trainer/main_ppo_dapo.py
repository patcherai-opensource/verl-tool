...
from verl_tool.trainer.dapo.ray_trainer import AgentRayDAPOTrainer as RayDAPOTrainer
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        # our customized agent worker supporting tool calls
        ...
        # we do not use kl reward, leaving out for now
        ...
        # TODO: implement combined acecoder+dapo reward manager
        elif reward_manager_name == 'acecoder_dapo':
            from verl_tool.agent_workers.reward_manager.acecoder_dapo import AceCoderDapoRewardManager
            reward_manager_cls = AceCoderDapoRewardManager
        ...
        if reward_manager_name == 'acecoder_dapo':
