...
max_response_length=4096 # bottleneck of the right side, will used in the training
max_obs_length=3096 # Not the bottleneck, the obs is much shorter than this
temperature=0.5
